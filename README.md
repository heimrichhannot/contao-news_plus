...
| venueName | text | Name of the venue. | addVenue |
| venueStreet | text | Street of the venue. | addVenue |
| venuePostal | text | Postal code of the venue. | addVenue |
| venueCity | text | City of the venue. | addVenue |
| venueCountry | text | Country of the venue. | addVenue |
| venueSingleCoords | text | Geo coordinates of the venue (if dlh_geocode is installed, the coordinates are ascertain from venueStreet, venueCity and venuePostal . | addVenue |
| venuePhone | text | Phone of venue. | addVenue |
| venueFax | text | Fax of the venue. | addVenue |
| venueEmail | text | Email of the venue. | addVenue |
| venueWebsite | text | Website of the venue. | addVenue |
| venueText | textarea | Freetext field for venue informations. | addVenue |
| **addArrivalInfo** | checkbox | Add a arrival informations to the news.  | leisuretip |
| arrivalName | text | Name of the arrival location. | addArrivalInfo |
| arrivalStreet | text | Street of the arrival location. | addArrivalInfo |
| arrivalPostal | text | Postal code of the arrival location. | leiaddArrivalInfosuretip |
| arrivalCity | text | City of the arrival location. | addArrivalInfo |
| arrivalCountry | text | Country of the arrival location. | addArrivalInfo |
| arrivalSingleCoords | text | Geo coordinates of the arrival location (if dlh_geocode is installed, the coordinates are ascertain from arrivalStreet, arrivalCity and arrivalPostal .  | addArrivalInfo |
| arrivalText | textarea | Freetext field for arrival informations. | addArrivalInfo |
| **addTouristInfo** | checkbox | Add tourist infos to the news.  | leisuretip |
| touristInfoName | text | Name of the tourist info. | addTouristInfo |
| touristInfoPhone | text | Phone of the tourist info. | addTouristInfo |
| touristInfoFax | text | Fax of the tourist info. | addTouristInfo |
| touristInfoEmail | text | Email of the tourist info. | addTouristInfo |
| touristInfoWebsite | text | Website of the tourist info. | addTouristInfo |
| touristInfoText | textarea | Additional text of the tourist info using tinyMCE.  | addTouristInfo |
| **addOpeningHours** | checkbox | Add opening hourse to the news. | leisuretip |
| openingHoursText | textarea | Freetext field for opening hours. | addOpeningHours |
| **addTicketPrice** | checkbox | Add ticket prices to the news. | leisuretip |
| ticketPriceText | textarea | Freetext field for ticket prices. | addTicketPrice |
